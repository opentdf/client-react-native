...
namespace virtru {
    ...
    public: // Encrypt and Decrypt
        ...
        //JAVACPPSKIPBEGIN
        /// Encrypt the contents of the data from source callback into a TDF. In the process of encryption, a policy is
        /// associated with the TDF. The policy has a unique id which can be used to identify the TDF policy.
        /// \param encryptDataParams  - Object holding all the required information for encrypt operations
        /// \return Policy uuid of the TDF, can be used later to update the policy controls
        std::string encryptData(const EncryptDataParams& encryptDataParams);
        //JAVACPPSKIPEND
        ...
        //JAVACPPSKIPBEGIN
        /// Decrypt the TDF data that is retrieved from the source callback.
